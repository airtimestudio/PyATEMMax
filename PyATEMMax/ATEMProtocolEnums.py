...
class ATEMNextTransistionKeys(ATEMConstantList):
    """next Transition list"""
    bkgd = ATEMConstant('background', 0)
    key1 = ATEMConstant('key1', 1)
    key2 = ATEMConstant('key2', 2)
    key3 = ATEMConstant('key3', 3)
    key4 = ATEMConstant('key4', 4)
